...
RS_cvd_all.pred_score.rsf.train.txt = read.delim('../../rsf/RS_cvd_all.pred_score.rsf.train.txt', header = F)
RS_cvd_all.pred_score.rsf.test.txt = read.delim('../../rsf/RS_cvd_all.pred_score.rsf.test.txt', header = F)
...
RS_cvd_sans_base.pred_score.rsf.train.txt = read.delim('../../rsf/RS_cvd_sans_base.pred_score.rsf.train.txt', header = F)
RS_cvd_sans_base.pred_score.rsf.test.txt = read.delim('../../rsf/RS_cvd_sans_base.pred_score.rsf.test.txt', header = F)
...
RS_cvd_lab.pred_score.rsf.train.txt = read.delim('../../rsf/RS_cvd_lab.pred_score.rsf.train.txt', header = F)
RS_cvd_lab.pred_score.rsf.test.txt = read.delim('../../rsf/RS_cvd_lab.pred_score.rsf.test.txt', header = F)
...
RS_cvd_lab_demo.pred_score.dsv.train.txt = read.delim('../../RS_cvd_lab_demo.pred_score.dsv.train.txt', header = F)
RS_cvd_lab_demo.pred_score.dsv.test.txt = read.delim('../../RS_cvd_lab_demo.pred_score.dsv.test.txt', header = F)
RS_cvd_lab_demo.pred_score.cox.train.txt = read.delim('../../RS_cvd_lab_demo.pred_score.cox.train.txt', header = F)
RS_cvd_lab_demo.pred_score.cox.test.txt = read.delim('../../RS_cvd_lab_demo.pred_score.cox.test.txt', header = F)
RS_cvd_lab_demo.pred_score.rsf.train.txt = read.delim('../../rsf/RS_cvd_lab_demo.pred_score.rsf.train.txt', header = F)
RS_cvd_lab_demo.pred_score.rsf.test.txt = read.delim('../../rsf/RS_cvd_lab_demo.pred_score.rsf.test.txt', header = F)
RS_cvd_lab_demo.E_train.txt = read.delim('../../RS_cvd_lab_demo.E_train.txt', header = F)
RS_cvd_lab_demo.T_train.txt = read.delim('../../RS_cvd_lab_demo.T_train.txt', header = F)
RS_cvd_lab_demo.E_test.txt = read.delim('../../RS_cvd_lab_demo.E_test.txt', header = F)
RS_cvd_lab_demo.T_test.txt = read.delim('../../RS_cvd_lab_demo.T_test.txt', header = F)

# dsv.pred = RS_cvd_lab.pred_score.dsv.test.txt
# rsf.pred = RS_cvd_lab.pred_score.rsf.test.txt
# cox.pred = RS_cvd_lab.pred_score.cox.test.txt
# labels = RS_cvd_lab.E_test.txt
...
cali.pipe = function(dsv.pred, rsf.pred, cox.pred, labels, auc.title){
  ...
  reliability_diagram(as.vector(RS_cvd_lab.E_test.txt[,1]),
...
cali.pipe(RS_cvd_all.pred_score.dsv.test.txt,
          RS_cvd_all.pred_score.rsf.test.txt,
          RS_cvd_all.pred_score.cox.test.txt,
          RS_cvd_all.E_test.txt,
          'ALL')

cali.pipe(RS_cvd_sans_base.pred_score.dsv.test.txt,
          RS_cvd_sans_base.pred_score.rsf.test.txt,
          RS_cvd_sans_base.pred_score.cox.test.txt,
          RS_cvd_sans_base.E_test.txt,
          'Sans Base')

cali.pipe(RS_cvd_lab.pred_score.dsv.test.txt,
          RS_cvd_lab.pred_score.rsf.test.txt,
          RS_cvd_lab.pred_score.cox.test.txt,
          RS_cvd_lab.E_test.txt, 
          'Lab')

cali.pipe(RS_cvd_lab_demo.pred_score.dsv.test.txt,
          RS_cvd_lab_demo.pred_score.rsf.test.txt,
          RS_cvd_lab_demo.pred_score.cox.test.txt,
          RS_cvd_lab_demo.E_test.txt,
          'Lab Demo')