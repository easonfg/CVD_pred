...
E_test = np.loadtxt('../RS_cvd_all.E_test.txt')
T_test = np.loadtxt('../RS_cvd_all.T_test.txt')
E_train = np.loadtxt('../RS_cvd_all.E_train.txt')
T_train = np.loadtxt('../RS_cvd_all.T_train.txt')
...
#sans base
E_test = np.loadtxt('../RS_cvd_sans_base.E_test.txt')
T_test = np.loadtxt('../RS_cvd_sans_base.T_test.txt')
E_train = np.loadtxt('../RS_cvd_sans_base.E_train.txt')
T_train = np.loadtxt('../RS_cvd_sans_base.T_train.txt')
...
#rsf = RandomSurvivalForest(n_estimators = 1000, verbose = 1, n_jobs=-2)
rsf.fit(X_train, RS_y)
#joblib.dump(rsf, "joblib_model_cvd_sans_base_rsf500n.pkl")
joblib.dump(rsf, "joblib_model_cvd_sans_base_rsf100n.pkl")
### make model
...
### lab
E_test = np.loadtxt('../RS_cvd_lab.E_test.txt')
T_test = np.loadtxt('../RS_cvd_lab.T_test.txt')
E_train = np.loadtxt('../RS_cvd_lab.E_train.txt')
T_train = np.loadtxt('../RS_cvd_lab.T_train.txt')
...
#rsf = RandomSurvivalForest(n_estimators = 1000, verbose = 1, n_jobs=-2)
rsf.fit(X_train, RS_y)
joblib.dump(rsf, "joblib_model_cvd_lab_rsf100n.pkl")
### make model
