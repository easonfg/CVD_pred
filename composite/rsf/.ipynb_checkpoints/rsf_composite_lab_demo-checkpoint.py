...
#### lab
E_test = np.loadtxt('../RS_composite_lab_demo.E_test.txt')
T_test = np.loadtxt('../RS_composite_lab_demo.T_test.txt')
E_train = np.loadtxt('../RS_composite_lab_demo.E_train.txt')
T_train = np.loadtxt('../RS_composite_lab_demo.T_train.txt')
...
#rsf = RandomSurvivalForest(n_estimators = 1000, verbose = 1, n_jobs=-2)
rsf.fit(X_train, RS_y)
joblib.dump(rsf, "joblib_model_composite_lab_demo_rsf100n.pkl")
### make model
